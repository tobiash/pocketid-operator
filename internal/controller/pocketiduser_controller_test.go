...
var _ = Describe("PocketIDUser Controller", func() {
	Context("When reconciling a resource", func() {
		...
		pocketiduser := &pocketidv1alpha1.PocketIDUser{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				...
				resource := &pocketidv1alpha1.PocketIDUser{
					ObjectMeta: metav1.ObjectMeta{
						Name:      resourceName,
						Namespace: "default",
					},
					Spec: pocketidv1alpha1.PocketIDUserSpec{
						InstanceRef: pocketidv1alpha1.CrossNamespaceObjectReference{Name: "test-instance"},
						Email:       &email,
						Username:    "testuser",
					},
				}
