...
var _ = BeforeSuite(func() {
	...
	// Find envtest binary path
	envtestAssets := filepath.Join("..", "..", "bin", "k8s")
	// Default to release-0.18 path structure (1.29.0-linux-amd64)
	envtestBin := filepath.Join(envtestAssets, "1.29.0-linux-amd64")
